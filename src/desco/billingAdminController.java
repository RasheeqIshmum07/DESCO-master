...
public class billingAdminController implements Initializable {
   ...
   private void viewCustomerBillPaneButtonOnClick(ActionEvent event) {
    switchPane(2);
       ...
       ViewBillNumberCustomerColumn.setCellValueFactory(new PropertyValueFactory<>(""));
       ...
       ViewBillAmountCustomerColumn.setCellValueFactory(new PropertyValueFactory<>("rate"));  
       CustomerIDTextField.setCellValueFactory(new PropertyValueFactory<>("userID"));  
       ViewUsageColumn.setCellValueFactory(new PropertyValueFactory<>("usage"));  
       ViewPaidColumn.setCellValueFactory(new PropertyValueFactory<>("Total"));    
